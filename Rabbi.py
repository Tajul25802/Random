...
----------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m Rabbi Islam
\033[1;37m[-] GITHUB    :\033[1;32m Hacker25805
        ...
        try:
                ...
                if 1==1:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open wa.me/+8801814032575');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100072425385396');menu()
                        elif xd in ['0','00']:
                                exit(' BY BY ')
                        else:
